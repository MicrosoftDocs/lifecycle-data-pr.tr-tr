...
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="b54e1-103">Yaşam döngüsü verilerini dışa aktarma</span><span class="sxs-lookup"><span data-stu-id="b54e1-103">Lifecycle data export</span></span>

## <a name="export-all-products"></a><span data-ttu-id="b54e1-104">Tüm ürünleri dışarı aktarma</span><span class="sxs-lookup"><span data-stu-id="b54e1-104">Export all products</span></span>
<span data-ttu-id="b54e1-105">Aşağıdaki bağlantıya tıklayarak tüm ürünler için yaşam döngüsü verilerini dışa aktarın:</span><span class="sxs-lookup"><span data-stu-id="b54e1-105">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="b54e1-106">Tüm Ürünleri Dışarı Aktarın</span><span class="sxs-lookup"><span data-stu-id="b54e1-106">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="b54e1-107">Aile ve Gruba göre dışarı aktarılan ürünler</span><span class="sxs-lookup"><span data-stu-id="b54e1-107">Export products by Family and Group</span></span>
<span data-ttu-id="b54e1-108">Dışarı aktarmak için bir Aile ve daha sonra Grup seçin.</span><span class="sxs-lookup"><span data-stu-id="b54e1-108">Select a Family and then a Group to export.</span></span> <span data-ttu-id="b54e1-109">Not: Dışarı aktarma işlemi Grup değeri seçildiğinde başlar.</span><span class="sxs-lookup"><span data-stu-id="b54e1-109">Note: Export will begin when Group value is selected.</span></span> 
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="b54e1-170">Destek tarihi sonuna kadar ürünleri dışarı aktarın</span><span class="sxs-lookup"><span data-stu-id="b54e1-170">Export products by end of support date</span></span>
<span data-ttu-id="b54e1-171">Aldığı desteğin sonuna ulaşan ürünleri görmek için bir yıl seçin.</span><span class="sxs-lookup"><span data-stu-id="b54e1-171">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="b54e1-172">Not: Yıl değeri seçildiğinde dışa aktarma başlar.</span><span class="sxs-lookup"><span data-stu-id="b54e1-172">Note: Export will begin when Year value is selected.</span></span>
